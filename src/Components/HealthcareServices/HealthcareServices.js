            ...
            <div className="col-12">
              <div className="card service-card border p-3 rounded-3 shadow">
                <div className="card-body m-3">
                  ...
                  <p className="card-text service-text text-muted">Submit your medical question and receive an answer from a specialized doctor.</p>
                  <button className="btn main-btn" onClick={handleAskNow}>Ask now</button>
                </div>
              </div>
            </div>
          </div>
