        ...
        <Row className='align-items-center justify-content-center mt-5 p-1'>
          <div className='col-sm-6 text-center'>
            <div className='rounded-5 shadow p-2 main-btn' >
              <p className='mb-0'>
                <span className='bg-danger badge rounded-pill text-light'>!</span>
        ...
        <Row className='justify-content-center m-0 p-3'>
          <div className='col-md-12'>
            ...
            <Row className='align-items-center m-0 p-3 justify-content-center mt-2'>
              ...
              <div className='col-sm-6 text-center'>
                <Button className='btn main-btn rounded-5 shadow-lg p-2' style={{ width: '80%', fontSize: '1rem' }} >Delete</Button>
              </div>
              <div className='col-sm-6 text-center mt-2 mt-sm-0'>
                <Button className='btn sec-btn rounded-5 shadow-lg p-2' style={{ width: '80%', fontSize: '1rem' }} >Cancel</Button>
              </div>
            </Row>
